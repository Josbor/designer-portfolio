    ...
    <section id="skills" className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="font-bold text-3xl mb-2 text-gray-800 dark:text-white">{ translations.skills.title }</h2>
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">{ translations.skills.description }</p>
        </div>
          ...
          { translations.skills.categories.map( ( category, index ) => (
            ...
            >
              <div className="flex items-center mb-4 justify-center md:justify-start">
                { getIcon( index ) }
                <h3 className="ml-3 font-medium text-lg text-gray-800 dark:text-white">{ category.title }</h3>
              </div>
